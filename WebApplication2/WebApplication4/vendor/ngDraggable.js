            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    var onpress = function(evt) {
                        size.height = angular.element(event.currentTarget).outerHeight();
                        size.width = angular.element(event.currentTarget).outerWidth();
                    ...
                    var onlongpress = function(evt) {
                        ...
                        element.css({ height: size.height, width: size.width });
